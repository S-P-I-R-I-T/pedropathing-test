...
public class RedFar extends OpMode {
    ...
    private final Pose startPose = new Pose(99.83128834355827, 34.5069018404908, Math.toRadians(90));
    private final Pose shootPose = new Pose(117.52712431004917, 34.88638677650822, Math.toRadians(0));
    private final Pose ppg1Pose = new Pose(84.75258872356827, 18.177379373597656, Math.toRadians(90));
    private final Pose pgp2Pose = new Pose(125.5, 63.71649618805944, Math.toRadians(90));
    private final Pose gpp3aPose = new Pose(130.18208488028222, 58.27518198255592, Math.toRadians(60));
    private final Pose gpp3bPose = new Pose(84.42457294373446, 18.572725148426848, Math.toRadians(48    ));
    ...
    public void buildPaths() {
        ...
        driveShootPosIntakeGPP1 = follower.pathBuilder()
                .addPath(new BezierCurve(shootPose, new Pose(59, 81), ppg1Pose))
                .setConstantHeadingInterpolation(ppg1Pose.getHeading())
                .build();


        driveIntakeGPP1ShootPos = follower.pathBuilder()
                .addPath(new BezierLine(ppg1Pose, shootPose))
                .setLinearHeadingInterpolation(ppg1Pose.getHeading(), shootPose.getHeading())
                .build();


        driveShootPosIntakeGPP2 = follower.pathBuilder()
                .addPath(new BezierCurve(shootPose, new Pose(75.18459302325581, 56.028343023255815), pgp2Pose))
                .setConstantHeadingInterpolation(pgp2Pose.getHeading())
                .build();


        driveIntakeGPP2ShootPos = follower.pathBuilder()
                .addPath(new BezierLine(pgp2Pose, shootPose))
                .setLinearHeadingInterpolation(pgp2Pose.getHeading(), shootPose.getHeading())
                .build();
