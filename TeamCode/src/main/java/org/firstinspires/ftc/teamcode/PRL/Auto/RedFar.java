...
public class RedFar extends OpMode {
    ...
    private final Pose startPose = new Pose(86.5, 8, Math.toRadians(0));
    private final Pose shootPose = new Pose(86.5, 15, Math.toRadians(0));
    private final Pose shootPose2 = new Pose(86.5, 15, Math.toRadians(0));

    private final Pose wp1Pose = new Pose(86.5, 36, Math.toRadians(0));
    private final Pose gpp1Pose = new Pose(131.5, 36, Math.toRadians(0));


    private final Pose leavePose = new Pose(95,15,Math.toRadians(180));
